...
class $PollOptionTableTable extends PollOptionTable
  ...
  late final GeneratedColumn<String> option = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string, requiredDuringInsert: true);
  @override
  List<GeneratedColumn> get $columns => [id, option];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class PollOptionDB extends DataClass implements Insertable<PollOptionDB> {
  final int? id;
  final String option;
  const PollOptionDB({this.id, required this.option});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    if (!nullToAbsent || id != null) {
  ...
  PollOptionDB copyWith(
          {Value<int?> id = const Value.absent(), String? option}) =>
      PollOptionDB(
        id: id.present ? id.value : this.id,
  ...
  @override
  int get hashCode => Object.hash(id, option);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class PollOptionTableCompanion extends UpdateCompanion<PollOptionDB> {
  ...
  PollOptionTableCompanion copyWith(
      {Value<int?>? id, Value<String>? option, Value<int>? rowid}) {
    return PollOptionTableCompanion(
      id: id ?? this.id,
      option: option ?? this.option,
      rowid: rowid ?? this.rowid,
...
class $PollTableTable extends PollTable
  ...
  late final GeneratedColumn<String> description = GeneratedColumn<String>(
      'description', aliasedName, true,
      type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _optionsIdMeta =
      const VerificationMeta('optionsId');
  @override
  late final GeneratedColumn<int> optionsId = GeneratedColumn<int>(
      'options_id', aliasedName, true,
      type: DriftSqlType.int,
      requiredDuringInsert: false,
      $customConstraints: 'REFERENCES poll_option_table(id)');
  @override
  List<GeneratedColumn> get $columns => [id, title, description, optionsId];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  VerificationContext validateIntegrity(Insertable<PollDB> instance,
    ...
    if (data.containsKey('options_id')) {
      context.handle(_optionsIdMeta,
          optionsId.isAcceptableOrUnknown(data['options_id']!, _optionsIdMeta));
    }
    return context;
  }
  ...
  PollDB map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return PollDB(
      ...
      description: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}description']),
      optionsId: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}options_id']),
    );
  }
...
class PollDB extends DataClass implements Insertable<PollDB> {
  ...
  final int? optionsId;
  const PollDB(
      {this.id, required this.title, this.description, this.optionsId});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    if (!nullToAbsent || id != null) {
    ...
    if (!nullToAbsent || optionsId != null) {
      map['options_id'] = Variable<int>(optionsId);
    }
    return map;
  }
  ...
  PollTableCompanion toCompanion(bool nullToAbsent) {
    return PollTableCompanion(
      ...
      description: description == null && nullToAbsent
          ? const Value.absent()
          : Value(description),
      optionsId: optionsId == null && nullToAbsent
          ? const Value.absent()
          : Value(optionsId),
    );
  }
  ...
  factory PollDB.fromJson(Map<String, dynamic> json,
    ...
    return PollDB(
      ...
      title: serializer.fromJson<String>(json['title']),
      description: serializer.fromJson<String?>(json['description']),
      optionsId: serializer.fromJson<int?>(json['optionsId']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'title': serializer.toJson<String>(title),
      'description': serializer.toJson<String?>(description),
      'optionsId': serializer.toJson<int?>(optionsId),
    };
  }
  ...
  PollDB copyWith(
          ...
          String? title,
          Value<String?> description = const Value.absent(),
          Value<int?> optionsId = const Value.absent()}) =>
      PollDB(
        id: id.present ? id.value : this.id,
        title: title ?? this.title,
        description: description.present ? description.value : this.description,
        optionsId: optionsId.present ? optionsId.value : this.optionsId,
      );
  PollDB copyWithCompanion(PollTableCompanion data) {
    return PollDB(
      ...
      description:
          data.description.present ? data.description.value : this.description,
      optionsId: data.optionsId.present ? data.optionsId.value : this.optionsId,
    );
  }
  ...
  String toString() {
    return (StringBuffer('PollDB(')
          ...
          ..write('title: $title, ')
          ..write('description: $description, ')
          ..write('optionsId: $optionsId')
          ..write(')'))
        .toString();
  }

  @override
  int get hashCode => Object.hash(id, title, description, optionsId);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is PollDB &&
          ...
          other.title == this.title &&
          other.description == this.description &&
          other.optionsId == this.optionsId);
}
...
class PollTableCompanion extends UpdateCompanion<PollDB> {
  ...
  final Value<String> title;
  final Value<String?> description;
  final Value<int?> optionsId;
  const PollTableCompanion({
    this.id = const Value.absent(),
    this.title = const Value.absent(),
    this.description = const Value.absent(),
    this.optionsId = const Value.absent(),
  });
  ...
  static Insertable<PollDB> custom({
    ...
    Expression<String>? title,
    Expression<String>? description,
    Expression<int>? optionsId,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (title != null) 'title': title,
      if (description != null) 'description': description,
      if (optionsId != null) 'options_id': optionsId,
    });
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (optionsId.present) {
      map['options_id'] = Variable<int>(optionsId.value);
    }
    return map;
  }
...
final class $$PollOptionTableTableReferences
  ...
  static MultiTypedResultKey<$PollTableTable, List<PollDB>> _pollTableRefsTable(
          _$AppDb db) =>
      MultiTypedResultKey.fromTable(db.pollTable,
          aliasName: $_aliasNameGenerator(
              db.pollOptionTable.id, db.pollTable.optionsId));

  $$PollTableTableProcessedTableManager get pollTableRefs {
    final manager = $$PollTableTableTableManager($_db, $_db.pollTable)
        .filter((f) => f.optionsId.id($_item.id));

    final cache = $_typedResult.readTableOrNull(_pollTableRefsTable($_db));
    return ProcessedTableManager(
        manager.$state.copyWith(prefetchedData: cache));
  }
}
...
class $$PollOptionTableTableFilterComposer
  ...
  ColumnFilters<String> get option => $composableBuilder(
      column: $table.option, builder: (column) => ColumnFilters(column));

  Expression<bool> pollTableRefs(
      Expression<bool> Function($$PollTableTableFilterComposer f) f) {
    final $$PollTableTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.id,
        referencedTable: $db.pollTable,
        getReferencedColumn: (t) => t.optionsId,
        builder: (joinBuilder,
                {$addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer}) =>
...
class $$PollOptionTableTableOrderingComposer
  ...
  ColumnOrderings<String> get option => $composableBuilder(
      column: $table.option, builder: (column) => ColumnOrderings(column));
}
...
class $$PollOptionTableTableAnnotationComposer
  ...
  Expression<T> pollTableRefs<T extends Object>(
      Expression<T> Function($$PollTableTableAnnotationComposer a) f) {
...
class $$PollOptionTableTableTableManager extends RootTableManager<
    ...
    PollOptionDB,
    PrefetchHooks Function({bool pollTableRefs})> {
  $$PollOptionTableTableTableManager(_$AppDb db, $PollOptionTableTable table)
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({pollTableRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [if (pollTableRefs) db.pollTable],
              addJoins: null,
              getPrefetchedDataCallback: (items) async {
                return [
                  if (pollTableRefs)
                    await $_getPrefetchedData(
                        currentTable: table,
                        referencedTable: $$PollOptionTableTableReferences
                            ._pollTableRefsTable(db),
                        managerFromTypedResult: (p0) =>
                            $$PollOptionTableTableReferences(db, table, p0)
                                .pollTableRefs,
                        referencedItemsForCurrentItem:
                            (item, referencedItems) => referencedItems
                                .where((e) => e.optionsId == item.id),
                        typedResults: items)
                ];
              },
            );
...
final class $$PollTableTableReferences
  ...
  static $PollOptionTableTable _optionsIdTable(_$AppDb db) =>
      db.pollOptionTable.createAlias(
          $_aliasNameGenerator(db.pollTable.optionsId, db.pollOptionTable.id));

  $$PollOptionTableTableProcessedTableManager? get optionsId {
    if ($_item.optionsId == null) return null;
    final manager =
        $$PollOptionTableTableTableManager($_db, $_db.pollOptionTable)
            .filter((f) => f.id($_item.optionsId!));
    final item = $_typedResult.readTableOrNull(_optionsIdTable($_db));
...
class $$PollTableTableFilterComposer
  ...
  $$PollOptionTableTableFilterComposer get optionsId {
    final $$PollOptionTableTableFilterComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.optionsId,
...
class $$PollTableTableOrderingComposer
  ...
  $$PollOptionTableTableOrderingComposer get optionsId {
    final $$PollOptionTableTableOrderingComposer composer = $composerBuilder(
        composer: this,
        getCurrentColumn: (t) => t.optionsId,
        referencedTable: $db.pollOptionTable,
        getReferencedColumn: (t) => t.id,
...
class $$PollTableTableAnnotationComposer
  ...
  $$PollOptionTableTableAnnotationComposer get optionsId {
...
class $$PollTableTableTableManager extends RootTableManager<
    ...
    PollDB,
    PrefetchHooks Function({bool optionsId, bool messagesTableRefs})> {
  $$PollTableTableTableManager(_$AppDb db, $PollTableTable table)
      : super(TableManagerState(
          ...
          prefetchHooksCallback: (
              {optionsId = false, messagesTableRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [
                if (messagesTableRefs) db.messagesTable
              ...
              addJoins: <
                ...
                if (optionsId) {
                  state = state.withJoin(
                    currentTable: table,
                    currentColumn: table.optionsId,
                    referencedTable:
                        $$PollTableTableReferences._optionsIdTable(db),
                    referencedColumn:
                        $$PollTableTableReferences._optionsIdTable(db).id,
                  ) as T;
                }
